            ...
            <div className={styles.container}>
                {facilidades.map((facilidade) => (
                    <div className={styles.facilidades__container}>
                        <img className={styles.facilidades__containerImg} src={`/assets/Facilidades/${facilidade.imagem}.png`} alt={`Imagem do ${facilidade.imagem}`} />

                        <div className={styles.facilidades__containerConteudo}>
                            <h4 className={styles.facilidades__containerConteudoTitulo}>{facilidade.titulo}</h4>
                            <p className={styles.facilidades__containerConteudoDescricao}>{facilidade.descricao}</p>
                        </div>
                    </div>
                ))}
            </div>
